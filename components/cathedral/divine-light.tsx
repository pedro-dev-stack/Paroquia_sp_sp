...
const dustParticles: DustParticle[] = Array.from({ length: 30 }, (_, i) => ({
  id: i,
...
export function DivineLight() {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <motion.div
        className="absolute -top-20 -right-20 w-[600px] h-[1200px] origin-top-right"
        style={{
      ...
      <motion.div
        className="absolute -top-10 right-1/4 w-[400px] h-[900px] origin-top"
        style={{
      ...
      <motion.div
        className="absolute top-0 -left-20 w-[300px] h-[800px] origin-top-left"
        style={{
